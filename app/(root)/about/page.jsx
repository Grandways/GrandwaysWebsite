      ...
      <div>
        ...
        <div className="w-full px-[135px] py-[50px] flex justify-between">
          <div className="flex flex-col items-center gap-[15px]">
            <p className="text-[36px] text-[#222952] font-bold">123</p>
        ...
        <div className="w-full flex flex-col px-[135px] py-[50px] gap-[50px]">
          ...
          <div className="flex gap-[50px]">
            <div className="w-[250px] flex flex-col items-center gap-[15px]">
              <div className="w-[75px] h-[75px] bg-[#222952] flex items-center justify-center rounded-[50px]">
